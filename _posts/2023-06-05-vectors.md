...
## Conclusion
We've covered what a vector is and the first few things we're going to do with them. Next up will be a couple more vector-specific operations: the dot and cross products.
...
[^VanVerth201633]: Van Verth, James M. & Bishop, Lars M. (2016)  *Essential Mathematics for Games and Interactive Applications*. CRC Press. p.33